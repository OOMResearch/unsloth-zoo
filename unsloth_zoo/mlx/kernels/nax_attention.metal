// Tile/fragment primitives for Apple GPU neural accelerators (NAX), vendored
// from MLX v0.32.1 (mlx/backend/metal/kernels/steel/{defines.h,
// utils/type_traits.h, utils/integral_constant.h, attn/nax.h}).
// Copyright © 2023-25 Apple Inc. MIT License, reproduced in NOTICE.md next to this file.
